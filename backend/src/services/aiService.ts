export class AiService {
    ...
    generateDailyInsights(data: any) {
        ...
        const metaSpend = data.find((d: any) => d.platform === 'Meta Ads')?.cost || 0;
        const googleSpend = data.find((d: any) => d.platform === 'Google Ads')?.cost || 0;
